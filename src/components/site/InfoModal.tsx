...
const AGENTS = [
  ...
  {
    icon: 'Calculator',
    name: 'Инженер-расчётчик',
    text: 'Считает конструкции, подбирает сечения и армирование, раскладывает вентиляцию, водоснабжение и электрику, оптимизируя трассы и убирая пересечения.',
  },
  {
    icon: 'ShieldCheck',
    name: 'Валидатор',
        ...
        <div className="mt-8">
          ...
          <ul className="mt-4 space-y-2.5">
            {[
              ...
              'Срок вместо недель — часы: типовой комплект по этапу выпускается за 8–12 часов.',
