    ...
    >
      ...
      >
        ...
        <p className="mt-5 text-[0.9rem] leading-relaxed text-muted-foreground">
          Институт обеспечивает интеграцию практического опыта инженерного состава с цифровыми системами поддержки
          проектирования. Автоматизированные модули выполняют формирование черновых планировочных решений, выполнение
          предварительных расчётов, подготовку спецификаций и проверку соответствия нормативным документам.
        </p>
        <p className="mt-4 text-[0.9rem] leading-relaxed text-muted-foreground">
          Инженерный персонал института осуществляет управление проектным процессом и несёт ответственность за
          принятие окончательных решений. Указанный порядок обеспечивает сокращение трудозатрат на подготовку
          документации до 40%, при этом утверждение и подписание проектной документации осуществляется исключительно
          аттестованным специалистом.
        </p>
