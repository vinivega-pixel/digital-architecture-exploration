      ...
      <div className="grid gap-14 lg:grid-cols-[1fr_1fr]">
        <div>
          ...
          <p className="mt-6 max-w-[42em] text-[0.95rem] leading-[1.8] text-muted-foreground">
            Мы проектируем, считаем и автоматизируем. На каждом этапе строительства слева — бесплатные расчёты,
            шаблоны документов и нормы, справа — цифровые продукты института: ИИ-агенты, офлайн-программы и готовые
            комплекты проектной и рабочей документации.
          </p>
